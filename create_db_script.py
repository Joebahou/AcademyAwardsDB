...
def create_database_script(cursor, DB_NAME):
    ...
    TABLES = {}
    TABLES['movie'] = ("CREATE TABLE movie (id INT NOT NULL PRIMARY KEY,title VARCHAR(150),"
    ...
    TABLES['person'] = ("CREATE TABLE person (id INT NOT NULL PRIMARY KEY,name VARCHAR(45),gender INT,"
                        "original_name VARCHAR(45) )")

    TABLES['jobInMovie'] = "CREATE TABLE jobInMovie(id INT NOT NULL PRIMARY KEY,job_name VARCHAR(45))"
    ...
    TABLES['award'] = (
        "CREATE TABLE award (id INT NOT NULL PRIMARY KEY,year INT NOT NULL,oscar_category_id INT NOT NULL"
